...
helm repo update
helm install scrypted geek-cookbook/scrypted
```
...
helm install scrypted \
  --set env.TZ="America/New York" \
    geek-cookbook/scrypted
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install scrypted geek-cookbook/scrypted -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/scrypted?modal=changelog)
