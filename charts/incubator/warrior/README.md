...
helm repo update
helm install warrior geek-cookbook/warrior
```
...
helm install warrior \
  --set env.TZ="America/New York" \
    geek-cookbook/warrior
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install warrior geek-cookbook/warrior -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/warrior?modal=changelog)
