...
helm repo update
helm install sdtd geek-cookbook/sdtd
```
...
```console
helm install sdtd geek-cookbook/sdtd -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/sdtd?modal=changelog)
