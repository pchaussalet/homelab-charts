...
helm repo update
helm install sinusbot geek-cookbook/sinusbot
```
...
helm install sinusbot \
  --set env.TZ="America/New York" \
    geek-cookbook/sinusbot
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install sinusbot geek-cookbook/sinusbot -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/sinusbot?modal=changelog)
