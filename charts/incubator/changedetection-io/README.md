...
* <https://github.com/geek-cookbook/charts/tree/master/charts/changedetection-io>
...
helm repo update
helm install changedetection-io geek-cookbook/changedetection-io
```
...
helm install changedetection-io \
  --set env.TZ="America/New York" \
    geek-cookbook/changedetection-io
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install changedetection-io geek-cookbook/changedetection-io -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/changedetection-io?modal=changelog)
