...
* <https://github.com/geek-cookbook/charts/tree/master/charts/stable/home-assistant>
...
helm install home-assistant \
  --set env.TZ="America/New York" \
    geek-cookbook/home-assistant
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install home-assistant geek-cookbook/home-assistant -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/home-assistant?modal=changelog)
