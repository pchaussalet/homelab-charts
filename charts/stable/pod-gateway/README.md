...
* <https://github.com/geek-cookbook/gateway-admision-controller>
* <https://github.com/geek-cookbook/pod-gateway>
...
helm repo update
helm install pod-gateway geek-cookbook/pod-gateway
```
...
helm install pod-gateway \
  --set env.TZ="America/New York" \
    geek-cookbook/pod-gateway
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install pod-gateway geek-cookbook/pod-gateway -f values.yaml
```

## Custom configuration

Please check [this guide](https://docs.geek-cookbook.com/guides/pod-gateway/)
...
[common chart VPN sidecar docummentation](https://github.com/geek-cookbook/library-charts/blob/main/charts/stable/common/values.yaml).
...
| image.repository | string | `"ghcr.io/geek-cookbook/pod-gateway"` | image repository of the gateway and inserted helper containers |
...
| webhook.image.repository | string | `"ghcr.io/geek-cookbook/gateway-admision-controller"` | image repository of the webhook |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/pod-gateway?modal=changelog)
