...
helm repo update
helm install unpackerr geek-cookbook/unpackerr
```
...
helm install unpackerr \
  --set env.TZ="America/New York" \
    geek-cookbook/unpackerr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install unpackerr geek-cookbook/unpackerr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/unpackerr?modal=changelog)
