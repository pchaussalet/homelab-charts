...
* <https://github.com/geek-cookbook/charts/tree/master/charts/youtubedl-material>
...
helm repo update
helm install youtubedl-material geek-cookbook/youtubedl-material
```
...
helm install youtubedl-material \
  --set env.TZ="America/New York" \
    geek-cookbook/youtubedl-material
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install youtubedl-material geek-cookbook/youtubedl-material -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/youtubedl-material?modal=changelog)
