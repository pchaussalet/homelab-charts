...
helm repo update
helm install onedrive geek-cookbook/onedrive
```
...
helm install onedrive \
  --set env.TZ="America/New York" \
    geek-cookbook/onedrive
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install onedrive geek-cookbook/onedrive -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/onedrive?modal=changelog)
