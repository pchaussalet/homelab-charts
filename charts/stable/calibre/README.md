...
helm repo update
helm install calibre geek-cookbook/calibre
```
...
helm install calibre \
  --set env.TZ="America/New York" \
    geek-cookbook/calibre
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install calibre geek-cookbook/calibre -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/calibre?modal=changelog)
