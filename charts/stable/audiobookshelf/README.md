...
helm repo update
helm install audiobookshelf geek-cookbook/audiobookshelf
```
...
helm install audiobookshelf \
  --set env.TZ="America/New York" \
    geek-cookbook/audiobookshelf
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install audiobookshelf geek-cookbook/audiobookshelf -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/audiobookshelf?modal=changelog)
