...
helm repo update
helm install heimdall geek-cookbook/heimdall
```
...
helm install heimdall \
  --set env.TZ="America/New York" \
    geek-cookbook/heimdall
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install heimdall geek-cookbook/heimdall -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/heimdall?modal=changelog)
