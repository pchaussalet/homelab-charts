...
* <https://github.com/geek-cookbook/charts/tree/master/charts/icantbelieveitsnotvaletudo>
...
helm repo update
helm install icantbelieveitsnotvaletudo geek-cookbook/icantbelieveitsnotvaletudo
```
...
helm install icantbelieveitsnotvaletudo \
  --set env.TZ="America/New York" \
    geek-cookbook/icantbelieveitsnotvaletudo
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install icantbelieveitsnotvaletudo geek-cookbook/icantbelieveitsnotvaletudo -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/icantbelieveitsnotvaletudo?modal=changelog)
