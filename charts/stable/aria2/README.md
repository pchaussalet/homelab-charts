...
helm repo update
helm install aria2 geek-cookbook/aria2
```
...
```console
helm install aria2 geek-cookbook/aria2 -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/aria2?modal=changelog)
