...
helm repo update
helm install gatus geek-cookbook/gatus
```
...
```console
helm install gatus geek-cookbook/gatus -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/gatus?modal=changelog)
