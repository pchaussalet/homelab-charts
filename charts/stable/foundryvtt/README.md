...
helm repo update
helm install foundryvtt geek-cookbook/foundryvtt
```
...
helm install foundryvtt \
  --set env.TZ="America/New York" \
    geek-cookbook/foundryvtt
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install foundryvtt geek-cookbook/foundryvtt -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/foundryvtt?modal=changelog)
