...
helm repo update
helm install neolink geek-cookbook/neolink
```
...
helm install neolink \
  --set env.TZ="America/New York" \
    geek-cookbook/neolink
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install neolink geek-cookbook/neolink -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/neolink?modal=changelog)
