...
helm repo update
helm install calibre-web geek-cookbook/calibre-web
```
...
helm install calibre-web \
  --set env.TZ="America/New York" \
    geek-cookbook/calibre-web
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install calibre-web geek-cookbook/calibre-web -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/calibre-web?modal=changelog)
