...
helm repo update
helm install wmbusmeters geek-cookbook/wmbusmeters
```
...
helm install wmbusmeters \
  --set env.TZ="America/New York" \
    geek-cookbook/wmbusmeters
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install wmbusmeters geek-cookbook/wmbusmeters -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/wmbusmeters?modal=changelog)
