...
helm repo update
helm install tt-rss geek-cookbook/tt-rss
```
...
helm install tt-rss \
  --set env.TZ="America/New York" \
    geek-cookbook/tt-rss
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install tt-rss geek-cookbook/tt-rss -f values.yaml
```
...
| image.repository | string | `"ghcr.io/geek-cookbook/tt-rss"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/tt-rss?modal=changelog)
