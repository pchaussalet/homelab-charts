...
helm repo update
helm install gonic geek-cookbook/gonic
```
...
```console
helm install gonic geek-cookbook/gonic -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/gonic?modal=changelog)
