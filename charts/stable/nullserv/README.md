...
helm repo update
helm install nullserv geek-cookbook/nullserv
```
...
helm install nullserv \
  --set env.TZ="America/New York" \
    geek-cookbook/nullserv
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install nullserv geek-cookbook/nullserv -f values.yaml
```
...
| image.repository | string | `"ghcr.io/geek-cookbook/nullserv"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/nullserv?modal=changelog)
