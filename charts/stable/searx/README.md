...
helm repo update
helm install searx geek-cookbook/searx
```
...
```console
helm install searx geek-cookbook/searx -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/searx?modal=changelog)
