...
helm repo update
helm install nzbhydra2 geek-cookbook/nzbhydra2
```
...
helm install nzbhydra2 \
  --set env.TZ="America/New York" \
    geek-cookbook/nzbhydra2
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install nzbhydra2 geek-cookbook/nzbhydra2 -f values.yaml
```
...
| image.repository | string | `"ghcr.io/geek-cookbook/nzbhydra2"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/nzbhydra2?modal=changelog)
