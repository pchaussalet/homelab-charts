...
helm repo update
helm install syncthing geek-cookbook/syncthing
```
...
helm install syncthing \
  --set env.TZ="America/New York" \
    geek-cookbook/syncthing
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install syncthing geek-cookbook/syncthing -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/syncthing?modal=changelog)
