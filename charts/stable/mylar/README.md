...
* <https://github.com/geek-cookbook/charts/tree/master/charts/mylar>
...
helm repo update
helm install mylar geek-cookbook/mylar
```
...
```console
helm install mylar geek-cookbook/mylar -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/mylar?modal=changelog)
