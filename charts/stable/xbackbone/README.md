...
helm repo update
helm install xbackbone geek-cookbook/xbackbone
```
...
helm install xbackbone \
  --set env.TZ="America/New York" \
    geek-cookbook/xbackbone
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install xbackbone geek-cookbook/xbackbone -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/xbackbone?modal=changelog)
