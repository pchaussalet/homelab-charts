...
helm repo update
helm install appdaemon geek-cookbook/appdaemon
```
...
helm install appdaemon \
  --set env.TZ="America/New York" \
    geek-cookbook/appdaemon
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install appdaemon geek-cookbook/appdaemon -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/appdaemon?modal=changelog)
