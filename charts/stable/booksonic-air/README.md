...
helm repo update
helm install booksonic-air geek-cookbook/booksonic-air
```
...
helm install booksonic-air \
  --set env.TZ="America/New York" \
    geek-cookbook/booksonic-air
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install booksonic-air geek-cookbook/booksonic-air -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/booksonic-air?modal=changelog)
