...
helm repo update
helm install reverse-proxy geek-cookbook/reverse-proxy
```
...
helm install reverse-proxy \
  --set env.TZ="America/New York" \
    geek-cookbook/reverse-proxy
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install reverse-proxy geek-cookbook/reverse-proxy -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/reverse-proxy?modal=changelog)
