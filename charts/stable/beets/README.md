...
helm repo update
helm install beets geek-cookbook/beets
```
...
```console
helm install beets geek-cookbook/beets -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/beets?modal=changelog)
