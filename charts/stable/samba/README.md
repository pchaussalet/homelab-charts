...
helm repo update
helm install samba geek-cookbook/samba
```
...
```console
helm install samba geek-cookbook/samba -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/samba?modal=changelog)
