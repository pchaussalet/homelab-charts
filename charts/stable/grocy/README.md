...
helm repo update
helm install grocy geek-cookbook/grocy
```
...
```console
helm install grocy geek-cookbook/grocy -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/grocy?modal=changelog)
