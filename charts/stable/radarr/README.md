...
helm repo update
helm install radarr geek-cookbook/radarr
```
...
helm install radarr \
  --set env.TZ="America/New York" \
    geek-cookbook/radarr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install radarr geek-cookbook/radarr -f values.yaml
```
...
| image.repository | string | `"ghcr.io/geek-cookbook/radarr"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/radarr?modal=changelog)
