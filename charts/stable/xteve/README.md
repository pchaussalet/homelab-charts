...
helm repo update
helm install xteve geek-cookbook/xteve
```
...
```console
helm install xteve geek-cookbook/xteve -f values.yaml
```
...
| image.repository | string | `"ghcr.io/geek-cookbook/xteve"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/xteve?modal=changelog)
