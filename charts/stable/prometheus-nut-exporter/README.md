...
helm repo update
helm install prometheus-nut-exporter geek-cookbook/prometheus-nut-exporter
```
...
helm install prometheus-nut-exporter \
  --set env.TZ="America/New York" \
    geek-cookbook/prometheus-nut-exporter
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install prometheus-nut-exporter geek-cookbook/prometheus-nut-exporter -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/prometheus-nut-exporter?modal=changelog)
