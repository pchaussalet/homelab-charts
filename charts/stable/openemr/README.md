...
helm repo update
helm install openemr geek-cookbook/openemr
```
...
helm install openemr \
  --set env.TZ="America/New York" \
    geek-cookbook/openemr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install openemr geek-cookbook/openemr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/openemr?modal=changelog)
