...
* <https://github.com/geek-cookbook/charts/tree/master/charts/omada-controller>
...
helm repo update
helm install omada-controller geek-cookbook/omada-controller
```
...
helm install omada-controller \
  --set env.TZ="America/New York" \
    geek-cookbook/omada-controller
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install omada-controller geek-cookbook/omada-controller -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/omada-controller?modal=changelog)
