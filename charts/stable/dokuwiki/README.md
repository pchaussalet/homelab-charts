...
helm repo update
helm install dokuwiki geek-cookbook/dokuwiki
```
...
helm install dokuwiki \
  --set env.TZ="America/New York" \
    geek-cookbook/dokuwiki
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install dokuwiki geek-cookbook/dokuwiki -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/dokuwiki?modal=changelog)
