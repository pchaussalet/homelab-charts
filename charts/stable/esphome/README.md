...
helm repo update
helm install esphome geek-cookbook/esphome
```
...
helm install esphome \
  --set env.TZ="America/New York" \
    geek-cookbook/esphome
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install esphome geek-cookbook/esphome -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/esphome?modal=changelog)
