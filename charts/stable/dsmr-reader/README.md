...
helm repo update
helm install dsmr-reader geek-cookbook/dsmr-reader
```
...
helm install dsmr-reader \
  --set env.TZ="America/New York" \
    geek-cookbook/dsmr-reader
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install dsmr-reader geek-cookbook/dsmr-reader -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/dsmr-reader?modal=changelog)
