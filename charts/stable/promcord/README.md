...
helm repo update
helm install promcord geek-cookbook/promcord
```
...
helm install promcord \
  --set env.TZ="America/New York" \
    geek-cookbook/promcord
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install promcord geek-cookbook/promcord -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/promcord?modal=changelog)
