...
helm repo update
helm install uptime-kuma geek-cookbook/uptime-kuma
```
...
helm install uptime-kuma \
  --set env.TZ="America/New York" \
    geek-cookbook/uptime-kuma
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install uptime-kuma geek-cookbook/uptime-kuma -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/uptime-kuma?modal=changelog)
