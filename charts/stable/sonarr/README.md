...
helm repo update
helm install sonarr geek-cookbook/sonarr
```
...
helm install sonarr \
  --set env.TZ="America/New York" \
    geek-cookbook/sonarr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install sonarr geek-cookbook/sonarr -f values.yaml
```
...
| image.repository | string | `"ghcr.io/geek-cookbook/sonarr"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/sonarr?modal=changelog)
