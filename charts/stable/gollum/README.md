...
helm repo update
helm install gollum geek-cookbook/gollum
```
...
helm install gollum \
  --set env.TZ="America/New York" \
    geek-cookbook/gollum
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install gollum geek-cookbook/gollum -f values.yaml
```
...
| gollum.gitUrl | string | `"https://github.com/geek-cookbook/charts.git"` | Repository URL to pull (accepts access tokens) Example: https://user:access-token@git.example.com/user/repo.git |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/gollum?modal=changelog)
