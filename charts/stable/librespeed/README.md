...
* <https://github.com/geek-cookbook/charts/tree/master/charts/librespeed>
...
helm repo update
helm install librespeed geek-cookbook/librespeed
```
...
helm install librespeed \
  --set env.TZ="America/New York" \
    geek-cookbook/librespeed
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install librespeed geek-cookbook/librespeed -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/librespeed?modal=changelog)
