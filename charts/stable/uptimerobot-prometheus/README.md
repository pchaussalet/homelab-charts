...
* <https://github.com/geek-cookbook/charts/tree/master/charts/uptimerobot-prometheus>
...
helm install uptimerobot-prometheus \
  --set env.TZ="America/New York" \
    geek-cookbook/uptimerobot-prometheus
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install uptimerobot-prometheus geek-cookbook/uptimerobot-prometheus -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/uptimerobot-prometheus?modal=changelog)
