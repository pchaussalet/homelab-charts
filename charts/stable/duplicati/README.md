...
helm install duplicati \
  --set env.TZ="America/New York" \
    geek-cookbook/duplicati
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install duplicati geek-cookbook/duplicati -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/duplicati?modal=changelog)
