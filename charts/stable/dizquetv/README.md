...
helm repo update
helm install dizquetv geek-cookbook/dizquetv
```
...
helm install dizquetv \
  --set env.TZ="America/New York" \
    geek-cookbook/dizquetv
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install dizquetv geek-cookbook/dizquetv -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/dizquetv?modal=changelog)
