...
helm repo update
helm install paperless geek-cookbook/paperless
```
...
helm install paperless \
  --set env.TZ="America/New York" \
    geek-cookbook/paperless
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install paperless geek-cookbook/paperless -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/paperless?modal=changelog)
