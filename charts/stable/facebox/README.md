...
helm repo update
helm install facebox geek-cookbook/facebox
```
...
helm install facebox \
  --set env.TZ="America/New York" \
    geek-cookbook/facebox
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install facebox geek-cookbook/facebox -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/facebox?modal=changelog)
