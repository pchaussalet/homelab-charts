...
helm repo update
helm install flood geek-cookbook/flood
```
...
```console
helm install flood geek-cookbook/flood -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/flood?modal=changelog)
