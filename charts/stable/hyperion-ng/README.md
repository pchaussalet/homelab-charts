...
helm repo update
helm install hyperion-ng geek-cookbook/hyperion-ng
```
...
helm install hyperion-ng \
  --set env.TZ="America/New York" \
    geek-cookbook/hyperion-ng
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install hyperion-ng geek-cookbook/hyperion-ng -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/hyperion-ng?modal=changelog)
