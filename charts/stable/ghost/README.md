...
helm repo update
helm install ghost geek-cookbook/ghost
```
...
```console
helm install ghost geek-cookbook/ghost -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/ghost?modal=changelog)
