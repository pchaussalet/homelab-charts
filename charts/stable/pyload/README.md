...
helm repo update
helm install pyload geek-cookbook/pyload
```
...
helm install pyload \
  --set env.TZ="America/New York" \
    geek-cookbook/pyload
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install pyload geek-cookbook/pyload -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/pyload?modal=changelog)
