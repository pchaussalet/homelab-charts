...
helm repo update
helm install monica geek-cookbook/monica
```
...
helm install monica \
  --set env.TZ="America/New York" \
    geek-cookbook/monica
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install monica geek-cookbook/monica -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/monica?modal=changelog)
