...
helm repo update
helm install jellyfin geek-cookbook/jellyfin
```
...
helm install jellyfin \
  --set env.TZ="America/New York" \
    geek-cookbook/jellyfin
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install jellyfin geek-cookbook/jellyfin -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/jellyfin?modal=changelog)
