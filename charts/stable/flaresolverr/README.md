...
helm repo update
helm install flaresolverr geek-cookbook/flaresolverr
```
...
helm install flaresolverr \
  --set env.TZ="America/New York" \
    geek-cookbook/flaresolverr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install flaresolverr geek-cookbook/flaresolverr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/flaresolverr?modal=changelog)
