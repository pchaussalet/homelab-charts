...
helm repo update
helm install unifi-poller geek-cookbook/unifi-poller
```
...
helm install unifi-poller \
  --set env.TZ="America/New York" \
    geek-cookbook/unifi-poller
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install unifi-poller geek-cookbook/unifi-poller -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/unifi-poller?modal=changelog)
