...
helm repo update
helm install games-on-whales geek-cookbook/games-on-whales
```
...
helm install games-on-whales \
  --set env.TZ="America/New York" \
    geek-cookbook/games-on-whales
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install games-on-whales geek-cookbook/games-on-whales -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/games-on-whales?modal=changelog)
