...
* <https://github.com/geek-cookbook/charts/tree/master/charts/airsonic>
...
helm repo update
helm install airsonic geek-cookbook/airsonic
```
...
helm install airsonic \
  --set env.TZ="America/New York" \
    geek-cookbook/airsonic
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install airsonic geek-cookbook/airsonic -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/airsonic?modal=changelog)
