...
helm repo update
helm install resilio-sync geek-cookbook/resilio-sync
```
...
helm install resilio-sync \
  --set env.TZ="America/New York" \
    geek-cookbook/resilio-sync
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install resilio-sync geek-cookbook/resilio-sync -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/resilio-sync?modal=changelog)
