...
helm repo update
helm install overseerr geek-cookbook/overseerr
```
...
helm install overseerr \
  --set env.TZ="America/New York" \
    geek-cookbook/overseerr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install overseerr geek-cookbook/overseerr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/overseerr?modal=changelog)
