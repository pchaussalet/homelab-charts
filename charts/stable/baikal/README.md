...
helm repo update
helm install baikal geek-cookbook/baikal
```
...
helm install baikal \
  --set env.TZ="America/New York" \
    geek-cookbook/baikal
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install baikal geek-cookbook/baikal -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/baikal?modal=changelog)
