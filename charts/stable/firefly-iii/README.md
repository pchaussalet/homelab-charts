...
helm repo update
helm install firefly-iii geek-cookbook/firefly-iii
```
...
helm install firefly-iii \
  --set env.TZ="America/New York" \
    geek-cookbook/firefly-iii
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install firefly-iii geek-cookbook/firefly-iii -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/firefly-iii?modal=changelog)
