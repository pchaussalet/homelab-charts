...
helm repo update
helm install valheim geek-cookbook/valheim
```
...
helm install valheim \
  --set env.TZ="America/New York" \
    geek-cookbook/valheim
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install valheim geek-cookbook/valheim -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/valheim?modal=changelog)
