...
helm repo update
helm install bazarr geek-cookbook/bazarr
```
...
helm install bazarr \
  --set env.TZ="America/New York" \
    geek-cookbook/bazarr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install bazarr geek-cookbook/bazarr -f values.yaml
```
...
| image.repository | string | `"ghcr.io/geek-cookbook/bazarr"` | image repository |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/bazarr?modal=changelog)
