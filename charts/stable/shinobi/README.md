...
helm repo update
helm install shinobi geek-cookbook/shinobi
```
...
helm install shinobi \
  --set env.TZ="America/New York" \
    geek-cookbook/shinobi
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install shinobi geek-cookbook/shinobi -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/shinobi?modal=changelog)
